...
//@Aliaus
#include "hugenums_36.h"	//labai dideli skaiciai [0-9]
#include "hugenums_48.h"	//labai dideli skaiciai [0-9]
#include "hugenums_72.h"	//labai dideli skaiciai [0-9]
#include "lcdnums_60.h"	    //labai dideli skaiciai [0-9]
#include "capacitor_60.h" 	//labai dideli skaiciai [0-9]
#include "lato_60.h" 	//labai dideli skaiciai [0-9]
#include "lato_50.h" 	//labai dideli skaiciai [0-9]
#include "webdings.h"	//skaiciai 3-4 yra trikampes rodykles
